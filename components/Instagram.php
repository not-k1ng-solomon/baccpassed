...
class Instagram
{
    ...
    public static  function SendRequest($url, $post, $post_data, $user_agent, $cookies) {
        $ch = curl_init();
    ...
    public static function GetPostData($filename) {
        if(!$filename) {
            return "The image doesn't exist ".$filename;
        } else {
    ...
    public static function postInstagram($username,$password,$filename, $caption){
